# Welcome to Astryx Help

Astryx is an astrophotography planning tool that helps you identify deep sky
objects, plan imaging sessions, and maintain an imaging log.
...
Astryx requires no internet connection and is designed for use in the field.
It runs in any modern browser, either locally or from the hosted version at
[astryx.tools](https://astryx.tools).
